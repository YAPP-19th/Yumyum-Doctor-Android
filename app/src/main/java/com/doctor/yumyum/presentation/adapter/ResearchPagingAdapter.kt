...
val RECIPE_COMPARATOR = object : DiffUtil.ItemCallback<RecipeModel>() {
...
class ResearchPagingAdapter(
    ...
    PagingDataAdapter<RecipeModel, ResearchPagingAdapter.ViewHolder>(RECIPE_COMPARATOR) {
